...
export declare namespace CrayonNftMarket {
...
export interface CrayonNftMarketInterface extends utils.Interface {
  functions: {
...
export interface CrayonNftMarket extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrayonNftMarketInterface;
  ...
  functions: {
    ...
    ): Promise<[CrayonNftMarket.MarketItemStructOutput[]]>;
